...
```{r setup, include=FALSE, echo = FALSE, results='hide', echo = FALSE, collapse = TRUE}
knitr::opts_chunk$set(echo = FALSE, cache = TRUE, collapse = TRUE)
library(readr)
library(tidyverse)
library(stringr)
```
...
df %>%
  ...
  mutate(
    Q3 = case_when(
      ...
      phone_format(Q3, "nokia"),
      phone_format(Q3, "sony_ericsson", function(param) {
        str_replace(param, "_", " ")
      }),
      TRUE ~ Q3
    )
